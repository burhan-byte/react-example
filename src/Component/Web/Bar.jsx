...
import IconButton from '@mui/material/IconButton';
import MenuIcon from '@mui/icons-material/Menu';
import AssignmentIcon from '@mui/icons-material/Description'; // Changed icon
import InfoIcon from '@mui/icons-material/TableChart'; // Changed icon
import { Link, useNavigate } from 'react-router-dom';
      ...
      <AppBar position="static" sx={{ backgroundColor: '#e91e63' }}>
        <Toolbar>
          <Tabs value={value} onChange={handleChange}>
            <Tab
              label={
                <Link to="/side" className="menu-bars" style={{ textDecoration: 'none', color: '#FFFFFF' }}>
                  <AssignmentIcon sx={{ marginRight: 1 }} />
                  Lis Form
                </Link>
              }
            ...
            <Tab
              label={
                <Link to="/sine" className="menu-bars" style={{ textDecoration: 'none', color: '#FFFFFF' }}>
                  <InfoIcon sx={{ marginRight: 1 }} />
                  Table
                </Link>
              }
